...
module.exports = {
  pathPrefix: '/francais', // prefix name of the blog to use when building page
  siteMetadata: {
    title: 'Le Blog Français',
    description: 'Bienvenue!',
    siteUrl: 'https://mattborghi.github.io/francais', // full path to blog - no ending slash
  },
  mapping: {
